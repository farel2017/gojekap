...
$headers[] = 'X-Location: 3.5954493,98.6777972';

        echo "\n";
        echo "\e[92m--------------------------------------------------\n";
        echo "\e[31m|           NOT SAFE FOR WORK IF 15              |\n";
        echo "\e[35m|         Recode doesn't make you a pro          |\n";
        echo "\e[32m|             Thanks to GOOGLE                   |\n";
        echo "\e[33m|              Author : Cupiz                    |\n";
        echo "\e[92m--------------------------------------------------\n";
        echo "\n";
        ulang:
...
echo "\e[96m[!] Mencoba Reedem Voucher 20+10 : GOFOODSENANG19 \n";
$data3 = '{"promo_code":"GOFOODSENANG19"}';
...
echo "\e[96m[!] Mencoba Reedem Voucher 10+10 : GOFOODHORAS \n";
$data4 = '{"promo_code":"GOFOODHORAS"}';
...
function request($url, $token = null, $data = null, $pin = null, $otpsetpin = null, $uuid = null)
    ...
    $header[] = "X-Location: 3.5954493,98.6777972";
